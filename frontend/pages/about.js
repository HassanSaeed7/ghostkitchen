...
const about = () => {
  return (
    ...
    <div className='max-w-screen-lg my-20 flex flex-col justify-center gap-3 m-auto'>
        <h2 className='text-center font-bold text-5xl mb-10 text-indigo-600'>About Us</h2>
        ...
        <p className='leading-8'>
        Ut enim ad minim veniam, quis nostrud exercise nulla pariatur et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercise nulla pariatur et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercise nulla pariatur et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercise nulla pariatur et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercise nulla pariatur et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercise nulla pariatur et dolore magna aliqua.
        </p>
    ...
    <div className='max-w-screen-lg mb-20 flex flex-col justify-center gap-3 m-auto'>
        <h2 className='text-center font-bold text-5xl mb-10 text-indigo-600'>About CBD</h2>
        <p className='leading-8'>
