...
const privacy = () => {
  return (
    <div className="m-auto flex flex-col gap-10 my-10 xl:max-w-screen-xl lg:max-w-screen-lg md:max-w-screen-md sm:max-w-xs">
        ...
        <h1 className='text-5xl font-bold mb-4'>Privacy Policy for WHOLESALE</h1>

      <p>
        At WEBSITE, accessible from WEBSITE.com, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by WEBSITE and how we use
        it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in WEBSITE. This policy is not applicable to any
        ...
        <div>
    <h2 className='font-bold mb-4'>Consent</h2>
...
<section>
    <h2 className='font-bold mb-4'>Log Files</h2>

      <p>
        WEBSITE follows a standard procedure of using log files. These files log
...
<section>
     <h2 className='font-bold mb-4'>Cookies and Web Beacons</h2>
...
<section>
    <h2 className='font-bold mb-4'>Advertising Partners Privacy Policies</h2>

      <p>
        You may consult this list to find the Privacy Policy for each of the
        advertising partners of WEBSITE.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on WEBSITE, which are sent directly
      ...
      <p>
        Note that WEBSITE has no access to or control over these cookies that
        are used by third-party advertisers.
      </p>
</section>

<section>
    <h2 className='font-bold mb-4'>Third Party Privacy Policies</h2>
...
<section>
    <h2 className='font-bold mb-4'>GDPR Data Protection Rights</h2>
...
<section>
     <h2 className='font-bold mb-4'>Children's Information</h2>
      ...
      <p>
        WEBSITE does not knowingly collect any Personal Identifiable Information
