...
const Featured = () => {
  return (
    <div className='min-h-screen m-auto'>
        <h2 className='text-5xl font-bold text-center my-5'>Taste of <span className='text-indigo-600'>Pakistan</span></h2>
        ...
        <div className=' relative lg:flex gap-12 items-center py-5 my-5'>
          ...
          <div className='w-2/4 p-5'>
            ...
            <p className='leading-relaxed text-gray-500'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercise nulla pariatur et dolore magna aliqua.
            </p>
          </div>
        </div>
        ...
        <Image src={image0} alt='display image' width={800} height={600} className='rounded-lg drop-shadow-md translate-x-10' />
          <div className='w-2/4 p-5'>
            ...
            <p className='leading-relaxed text-gray-500 text-justify'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercise nulla pariatur et dolore magna aliqua.
            </p>
          </div>
        </div>
